...
class LineController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $lines = $em->getRepository('OrderBundle:Line')->findAll();

        return $this->render('OrderBundle:Order/line:index.html.twig', array(
            'lines' => $lines,
        ));
    }
    ...
    {
        $line = new Line();
        $form = $this->createForm('OrderBundle\Form\LineType', $line);
        ...
        return $this->render('OrderBundle:Order/line:new.html.twig', array(
            'line' => $line,
    ...
    public function showAction(Line $line)
    {
        ...
        return $this->render('OrderBundle:Order/line:show.html.twig', array(
            'line' => $line,
    ...
    {
        $deleteForm = $this->createDeleteForm($line);
        $editForm = $this->createForm('OrderBundle\Form\LineType', $line);
        ...
        return $this->render('OrderBundle:Order/line:edit.html.twig', array(
            'line' => $line,
